...
- artifacts: `cheat/patch.diff`, `cheat/proposal.json`, `cheat/audit/audit_result.json`, `cheat/audit/trusted_metrics.json`, `cheat/audit/verdict.json`, `cheat/audit/audit_report.md`, `cheat/audit/manifest.json`
...
- artifacts: `repair/patch.diff`, `repair/proposal.json`, `repair/audit/audit_result.json`, `repair/audit/trusted_metrics.json`, `repair/audit/verdict.json`, `repair/audit/audit_report.md`, `repair/audit/manifest.json`
